...
from .routes import deduplication_status, energetske_izkaznice_status, fill_deduplicated_tables, get_del_stavbe_details, ingest_data, ingest_energetske_izkaznice, ingestion_status, get_del_stavbe_geojson, get_cluster_del_stavbe, posodobi_statistike, splosne_statistike, statistike_status, vse_statistike
