...
export default function Podrobnosti({ propertyId, dataSource = 'np', onClose }) {
  ...
  const [activeTab, setActiveTab] = useState('posli'); // 'details' ali 'posli' - mobile starts with posli
  ...
  const selectPosel = (poselId) => {
    ...
    // On mobile, switch to details tab when selecting a posel and scroll to top
    if (isMobile) {
      ...
      // On desktop, scroll to the posel in the sidebar
          ...
          <div className="relative shadow-xl w-full h-full overflow-hidden flex flex-col">
            ...
            <div className="relative backdrop-blur">
              ...
              <div className={`relative ${colors.headerText} p-3 border-b border-gray-200`}>
                <div className="flex justify-between items-start">
                  ...
                  <button
                    onClick={onClose}
                    className="text-gray-600 hover:bg-gray-200 rounded-full w-8 h-8 flex items-center justify-center transition-colors ml-2 flex-shrink-0"
                  >
              ...
              <div className="bg-white border-b border-gray-200">
                <div className="flex">
                  <button
                    ...
                    className={`flex-1 py-3 px-4 text-sm font-medium border-b-2 transition-colors ${activeTab === 'posli'
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 px-4 text-sm font-medium border-b-2 transition-colors ${activeTab === 'details'
                      ? 'border-blue-500 text-blue-600 bg-blue-50'
                      : 'border-transparent text-gray-500 hover:text-gray-700'
                      }`}
                  >
            ...
            <div className="flex-1 bg-gray-50 overflow-y-auto details-content">
              {loading ? (
                ...
                <div className="p-3">
                  {activeTab === 'posli' ? (
                    /* Mobile Posli Content */
                    <div className="space-y-3">
                      {property.povezani_posli?.map((posel) => {
                        ...
                        return (
                          <div
                            ...
                            className={`rounded-lg cursor-pointer transition-colors bg-white ${isSelected
                              ...
                              : 'hover:bg-gray-100 border border-gray-300 p-3'
                              }`}
                          >
                            <div className="space-y-3">
                              <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        ...
                        <div className="bg-white border border-gray-300 rounded-lg p-3">
                          ...
                          <div className="bg-gray-50 p-2 rounded text-sm">
                            <div className="grid grid-cols-1 gap-4">
                              ...
                              {representativeProperty.stevilo_sob > 0 && (
                        ...
                        <div className="bg-white border border-gray-300 rounded-lg p-3">
                          ...
                          <div className="bg-gray-50 p-2 rounded text-sm">
                            <div className="grid grid-cols-1 gap-4">
                              <DetailRow label="Številka stavbe" value={representativeProperty.stevilka_stavbe} />
                              ...
                              {representativeProperty.stavba_je_dokoncana == 0 && (
                      ...
                      {selectedPosel && filteredConnectedParts.length > 0 && (
                        <div className="bg-white border border-gray-300 rounded-lg p-3">
                          ...
                          {Object.entries(
                            filteredConnectedParts.reduce((groups, part) => {
                              ...
                              <div className="border border-t-0 border-gray-300 rounded-b-lg p-3">
                                <div className="grid grid-cols-1 gap-3">
                                  {group.parts.map((part) => (
                                    <div key={part.del_stavbe_id} className="bg-white border border-gray-200 rounded-lg p-3 shadow-sm">
                        ...
                        <div className="bg-white border border-gray-300 rounded-lg p-3">
                          ...
                          {Object.entries(
                            ...
                            <div key={groupKey} className="mb-4 last:mb-0">
                              ...
                              {/* Deli stavbe v tej skupini */}
                              <div className="border border-gray-300 rounded-b-lg p-3">
                                ...
                                <div className="space-y-3">
                                  ...
                                  <div>
                                    <div className="flex justify-between items-center">
                                      ...
                                      {dataSource === 'np' && (
                                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold text-gray-900 ${posel.vrsta_akta === 1 ? 'bg-gray-100' : 'bg-pink-100'}`}>
                                          {getVrstaAkta(posel.vrsta_akta)}
                                        </span>
                                      )}
                                    </div>
