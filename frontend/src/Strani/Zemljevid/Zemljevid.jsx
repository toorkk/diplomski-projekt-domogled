    ...
    return (
        <>
            ...
            <button
                ...
                className={`fixed z-40 w-14.5 h-14.5 bg-white hover:bg-gray-300 text-black rounded-full shadow-lg flex items-center justify-center transition-colors duration-200 ${isMobile
                        ? 'bottom-22 left-4.5' 
                        : 'top-10 left-2'    
                    }`}
                title="Pomoč - kako uporabljati aplikacijo"
            >
                <svg className="w-6.5 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
