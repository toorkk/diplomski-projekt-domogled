          ...
          <div className="pt-16 px-8 pb-8">
            <div className="space-y-10 max-w-5xl mx-auto">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-8">
                <h2 className="text-xl font-semibold mb-4 text-gray-900">Viri podatkov</h2>
                <div className="space-y-4 text-gray-700">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Zunanji viri podatkov (javni geodetski podatki)</h3>
                    <p className="mb-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Register energetskih izkaznic</h3>
                    <p className="mb-2">
              ...
              {/* Metodologija */}
              <div className="bg-white border border-gray-200 rounded-lg p-8">
                <h2 className="text-xl font-semibold mb-4 text-gray-900">Metodologija obdelave podatkov</h2>
                <div className="space-y-4 text-gray-700">
                  
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Prikazovanje podatkov na zemljevidu</h3>
                    <p className="mb-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Statistični izračuni</h3>
                    <p className="mb-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Čiščenje in validacija podatkov</h3>
                    <p className="mb-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Časovni okviri analiz</h3>
                    <p className="mb-2">
              ...
              {/* Posodobitve */}
              <div className="bg-white border border-gray-200 rounded-lg p-8">
                <h2 className="text-xl font-semibold mb-4 text-gray-900">Posodobitve podatkov</h2>
                <div className="space-y-4 text-gray-700">
                  
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Dinamično posodabljanje</h3>
                    <p className="mb-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Nepremičninski podatki (GURS)</h3>
                    <p className="mb-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Energetski podatki</h3>
                    <p className="mb-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Statistike in analitika</h3>
                    <p className="mb-2">
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 mt-4">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        <p className="text-sm text-green-800 font-medium">Zagotovilo svežih podatkov</p>
              ...
              {/* Kontakt */}
              <div className="bg-white border border-gray-200 rounded-lg p-8">
                <h2 className="text-xl font-semibold mb-4 text-gray-900">Kontakt in podpora</h2>
                <div className="space-y-4 text-gray-700">
                  
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Vprašanja in pomoč</h3>
                    <p className="mb-3">
                    ...
                    <div className="flex items-center space-x-3 bg-blue-50 border border-blue-200 rounded-lg p-4">
                      ...
                      <div>
                        <p className="font-medium text-blue-900">E-pošta</p>
                        <a 
